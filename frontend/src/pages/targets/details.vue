    ...
    <PanelLayout :title="target.name || '...'" :breadcrumb="['Websites', target.name || '...']">
        ...
        <div v-if="!loading && !error">
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <Card title="Uptime" class="h-100"> <div class="d-flex align-items-center">
                ...
                <div class="col-md-4">
                    <Card title="SSL Expiry" class="h-100"> <div class="d-flex align-items-center">
                ...
                <div class="col-md-4">
                    <Card title="Domain Expiry" class="h-100"> <div class="d-flex align-items-center">
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <Card title="Recent Status Logs" class="h-100"> <ul class="list-group list-group-flush">
                            <li v-if="recentStatusLogs.length === 0" class="list-group-item text-muted">
                                No recent status logs available for this target.
                            </li>
                            <li v-for="log in recentStatusLogs" :key="log.id" class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    <i :class="['bi', getIconForStatusCode(log.status_code), 'me-2']"></i>
                                    Status: <strong>{{ log.status_code }}</strong> - Response Time: {{ log.response_time_ms }}ms
                                </div>
                ...
                <div class="col-md-4">
                    <Card title="Recent Alerts" class="h-100"> <ul class="list-group list-group-flush">
                            <li v-if="targetAlerts.length === 0" class="list-group-item text-muted">
                                No recent alerts for this target.
                            </li>
                            <li v-for="alert in targetAlerts" :key="alert.id" class="list-group-item d-flex justify-content-between align-items-start">
                                <div>
