    ...
    <div class="card-body">
        <form @submit.prevent="addTarget">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="targetName" v-model="targetName"
                    placeholder="e.g., My Website" required />
            </div>
            <div class="mb-3">
                <label for="targetUrl" class="form-label">Website URL</label>
                <input type="url" class="form-control" id="targetUrl" v-model="newTargetUrl"
